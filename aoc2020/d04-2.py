...
def is_valid(passport, DBG = True):
    ...
    for m in mandatory:
        if not m in passport:
            if DBG: print("incomplete")
            return False
