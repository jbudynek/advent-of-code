...
def free_right(direction, xyids, curx, cury):
    if direction == 1:
        return xyids[(curx + 1, cury)] == "."
    elif direction == 2:
        return xyids[(curx - 1, cury)] == "."
    elif direction == 3:
        return xyids[(curx, cury + 1)] == "."
    elif direction == 4:
        return xyids[(curx, cury - 1)] == "."
...
while 1:
    ...
    output, dictcode, i, input_signals, input_index, relative_base = opcode_machine(
        dictcode,
        i,
        input_signals,
        input_index,
